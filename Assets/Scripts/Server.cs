...
public class Server : MonoBehaviour
{
    ...
    private void HandleTick(float deltaTime)
    {
        ...
        // TODO: THE ENTIRE ARCHITECTURE IS A LITTLE BIT FLAWED FOR NOW
        //       SO WHAT SHOULD BE DONE NEXT, I BELIEVE IS TRYING TO HANDLE
        //       CONTINIOUS LOGIC HERE LIKE PROJECTILES, OR MAYBE PLAYER STATE
        //       SERVER NEEDS TO REGULARLY SEND STATES TO CLIENT SO THAT THEY
        //       BE PROPERLY SYNCHRONIZED, I STILL DIDN'T TEST A LOT BUT I THINK
        //       SYNCHRONIZATION IS BADLY DONE RIGHT NOW.
